...
export default function Hero() {
    return (
        // <section className="relative mx-auto mb-60 flex h-screen max-w-[1200px] flex-col justify-center px-7 sm:mt-10 sm:px-13 md:mt-10 md:mb-70 md:px-26 lg:px-39">
        //     <div>
