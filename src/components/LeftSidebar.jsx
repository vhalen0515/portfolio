...
export default function LeftSidebar() {
    return (
        <div className="after:bg-main-txt-clr fixed bottom-0 left-4 hidden items-center [writing-mode:vertical-lr] after:block after:h-23 after:w-0.25 after:content-[''] md:flex lg:left-10 z-10">
            <a
